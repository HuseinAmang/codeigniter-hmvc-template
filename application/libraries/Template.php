...
class template
{
    ...
    private $_template = 'home/main.php'; // Default control panel template
    ...
    {
        if(file_exists(VIEWPATH. $template) or file_exists(VIEWPATH. $template . EXT)) {
            $this->_template = $template;
        } else {
            show_error('The filename provided does not exist in <strong>' . VIEWPATH . 'views</strong>. Remember to include the extension if other than ".php"');
        }
    }
    ...
    function _extract()
    {
        ...
        $this->_data['extra_css'] = $_css;
        
        $this->_data['extra_js'] = $_js;
    }
